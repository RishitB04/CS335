...
class tlangVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by tlangParser#listLiteral.
    def visitListLiteral(self, ctx:tlangParser.ListLiteralContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by tlangParser#listLiteralExpr.
